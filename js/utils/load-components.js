...
var _NAV_EVENTS_ATTENDEE = '<a href="../pages/attendees.html?tab=events" class="sidebar-link" data-page="att-events">'
  + '<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><rect x="3" y="4" width="18" height="18" rx="2" stroke="currentColor" stroke-width="2"/><path d="M16 2v4M8 2v4M3 10h18" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>'
  + '<span>Events</span></a>';
...
var _NAV_MY_TICKETS = '<a href="../pages/attendees.html?tab=tickets" class="sidebar-link" data-page="att-tickets">'
